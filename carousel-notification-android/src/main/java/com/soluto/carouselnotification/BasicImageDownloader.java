...
/**
 * Downloads carousel images and saves it into a file
 * @author Vadim Zuev
 * @version 1.1
 */
public class BasicImageDownloader {
    ...
    public BasicImageDownloader(Context context, ArrayList<CarouselItem> carouselItems, int numberOfImages, @NonNull OnDownloadsCompletedListener onDownloadsCompletedListener, LoggingApi logger) {
    ...
    private void updateDownLoad(String filePath) {
        ...
        for (int i = (currentDownloadTaskIndex + 1); i < carouselItems.size(); i++) {
            if (!TextUtils.isEmpty(carouselItems.get(i).getPhoto_url())) {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (bitmap != null) {
                        ...
                        int sampleSize = CarouselUtilities.carouselCalculateInSampleSize(bitmap.getWidth(), bitmap.getHeight(), 250, 250);
                        Bitmap bit = Bitmap.createScaledBitmap(bitmap, bitmap.getWidth()/sampleSize, bitmap.getHeight()/sampleSize, false);
                        imagePath = CarouselUtilities.carouselSaveBitmapToInternalStorage(context, bit, CarouselConstants.CAROUSEL_IMAGE_BEGENNING + currentTimeInMillis);
                    }
            ...
            protected void onPostExecute(String result) {
                if (result == null) {
                    ...
                    if (currentItem != null)
                        ...
                        currentItem.setImage_file_name(CarouselConstants.CAROUSEL_IMAGE_BEGENNING + currentTimeInMillis);
